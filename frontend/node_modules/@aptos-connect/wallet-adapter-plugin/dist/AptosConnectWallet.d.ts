import { ExtendedNetwork } from '@aptos-connect/wallet-api';
import { AccountAuthenticator, AnyRawTransaction, AptosSettings, HexInput } from '@aptos-labs/ts-sdk';
...
export declare abstract class AptosConnectWallet {
    ...
    private chainId?;
    private readonly chainIdPromise;
    constructor({ aptosClientConfig, claimSecretKey, network, preferredWalletName, ...clientConfig }: WithSSOProvider<AptosConnectWalletConfig>);
